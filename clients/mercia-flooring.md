...
## Current Status
Setup invoiced (INV-002, £250). School lists for all 4 target postcode areas built and ready. **Outlook/Entra OAuth fix reported by Solaas IT on 16 April, Andy confirming on 17 April.** If the fix is verified, school outreach batches can launch immediately — school lists have been ready since early April. The 15 April go-live slipped; actual go-live now depends on Outlook verification outcome. Gmail send-as workaround remains in reserve if Solaas IT verification fails.
...
| Date | Summary |
|------|---------|
| 2026-04-16 | Solaas IT reported Outlook/Entra fix applied. Andy to verify 17 April. If verified, first school batch can launch same day. |
