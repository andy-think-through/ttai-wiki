...
| Principle | Origin | Applies To |
|-----------|--------|------------|
| [[connectors-beat-computer-use]] | Wiki Agent migration to Routines (2026-04-15) | All agent architectures; default to APIs over browser automation |
| [[repos-are-employee-memory]] | Wiki Agent's first day on Routines (2026-04-16) | All ephemeral-session employees; write state early and often |
