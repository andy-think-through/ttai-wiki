...
| Principle | Origin | Applies To |
|-----------|--------|------------|
| [[connectors-beat-computer-use]] | Wiki Agent migration to Routines (2026-04-15) | Agent design, employee architecture, Agent Browser strategy |
| [[repos-are-employee-memory]] | Wiki Agent first day on Routines (2026-04-16) | All employees on ephemeral infrastructure, any cloud-based agent |
