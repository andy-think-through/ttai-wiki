...
| Principle | Origin | Applies To |
|-----------|--------|------------|
| [[connectors-beat-computer-use]] | Wiki Agent migration to Routines (2026-04-15) | All autonomous employees, Agent Browser optimisation roadmap, any agent architecture decision |
| [[repos-are-employee-memory]] | Wiki Agent migration to Routines (2026-04-15) | All autonomous employees on ephemeral platforms, future client agent deployments |
...
- **Infrastructure/Operations:** [[scheduled-tasks-need-zero-intervention]] + [[connectors-beat-computer-use]] + [[repos-are-employee-memory]]
...
- **Structured over visual:** [[connectors-beat-computer-use]] + [[trust-the-agent-not-dom]]
- **Agent architecture:** [[connectors-beat-computer-use]] + [[repos-are-employee-memory]] + [[scheduled-tasks-need-zero-intervention]]
