...
| Principle | Origin | Applies To |
|-----------|--------|------------|
| [[connectors-beat-computer-use]] | Wiki Agent migration to Routines (2026-04-15) | All employees, Agent Browser optimisation, any agent architecture |
| [[repos-are-employee-memory]] | Wiki Agent migration to Routines (2026-04-15) | All employees on ephemeral infrastructure, any serverless agent |
