...
## Operations & Architecture Principles (April 2026)

| Principle | Origin | Applies To |
|-----------|--------|------------|
| [[connectors-beat-computer-use]] | Wiki Agent migration to Routines (2026-04-15) | All agents; Agent Browser internal ops; Fred/Mark-Lite migration |
| [[repos-are-employee-memory]] | Routines architecture design (2026-04-15) | All autonomous employees; any agent on ephemeral infrastructure |
...
- **Infrastructure patterns:** [[connectors-beat-computer-use]] + [[repos-are-employee-memory]] + [[scheduled-tasks-need-zero-intervention]]
